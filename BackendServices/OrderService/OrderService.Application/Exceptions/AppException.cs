...
namespace OrderService.Application.Exceptions
{
    public sealed class AppException : Exception
    {
        ...
        public static AppException Validation(IDictionary<string, string[]> errors, string? detail = null, string? type = "urn:problem:order:validation.failed")
        ...
        public static AppException External(string service, HttpStatusCode upstreamStatus, string? responseBody = null)
            => new((int)HttpStatusCode.BadGateway,
                   ...
                   "urn:problem:order:external-service",
