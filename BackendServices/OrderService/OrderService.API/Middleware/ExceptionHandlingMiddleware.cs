...
namespace OrderService.API.Middleware
{
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            catch (OperationCanceledException) when (context.RequestAborted.IsCancellationRequested)
            {
                ...
                Log.ForContext("TraceId", traceId)
                   ...
                   .ForContext("RequestPath", context.Request.Path.Value)
                   .ForContext("RequestMethod", context.Request.Method)
                   .Information("Request cancelled by client");
            ...
            catch (Exception ex)
            {
                ...
                await WriteProblemAsync(context, StatusCodes.Status500InternalServerError,
                    ...
                    type: "urn:problem:order:unexpected",
                    correlationId: correlationId,
                    traceId: traceId);
            }
        }
    ...
    {
        public static IApplicationBuilder UseOrderExceptionHandling(this IApplicationBuilder app)
